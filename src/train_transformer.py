...
def main():
    ...
    model = train_model(device, dataloaders, dataset_sizes, model, criterion, optimizer, exp_lr_scheduler, num_epochs=20, weights_dir=weights_dir, special_tokens=special_tokens)
